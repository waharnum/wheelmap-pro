    ...
    return (
      <section className="questionnaire-step welcome"
        ...
        <span className="call-to-action">
          <div className="form">
            <div className="form-group">
              <button className="primary" onClick={this.startQuestionnaire.bind(this, question)}>{t`Okay`}</button>
            </div>
          </div>
        </span>
      </section>
...
export default styled(Questionnaire) `
  ...
  &.questionnaire-area {
    ...
    /* ARG: fix hidden in main form hack. See forms.scss */
    form .form-group .panel.panel-danger { 
      display:block;
